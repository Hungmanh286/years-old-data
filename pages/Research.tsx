                ...
                {isLoading ? (
                  ...
                  articles.map((article) => (
                    <article key={article.id} onClick={() => navigate(`/article/${article.id}`)} className="group cursor-pointer grid md:grid-cols-12 gap-6 items-start">
                      <div className="md:col-span-5 overflow-hidden bg-gray-100 relative">
                        ...
                        {article.heroImage ? (
                          ...
                          <div className="w-full aspect-[4/3] bg-gray-200 flex items-center justify-center text-gray-400 text-xs">
                            [No Image]
                          </div>
                        )}
                      </div>
